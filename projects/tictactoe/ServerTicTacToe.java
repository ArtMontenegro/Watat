...
public class ServerTicTacToe {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Wainting conection with player O...");
        Socket clientSocket = serverSocket.accept();
        System.out.println("Player O conected!");
        ...
        while (gameOn) {
            ...
            if (currentPlayer == 'X') {
                System.out.println("Your turn (X). Enter line and column (0-2):");
                ...
                System.out.println("Wainting for player O's move...");
